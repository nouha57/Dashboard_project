                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <StyledTableCell>{row.humidity}</StyledTableCell>
                      <StyledTableCell>{row.min_temp}</StyledTableCell>
                      <StyledTableCell>{row.max_temp}</StyledTableCell>
                      <StyledTableCell>{row.min_hum}</StyledTableCell>
                      <StyledTableCell>{row.max_hum}</StyledTableCell>
                    </StyledTableRow>
                  );
                })}
            </TableBody>
